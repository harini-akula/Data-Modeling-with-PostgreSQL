...
songplay_table_create = (
    ...
    start_time timestamp NOT NULL, user_id int NOT NULL, level varchar NOT NULL, song_id varchar, 
...
user_table_create = (
    ...
    gender varchar(1) NOT NULL, level varchar NOT NULL)
    """
)
...
song_table_create = (
    ...
    title varchar NOT NULL, artist_id varchar NOT NULL, year int, duration decimal NOT NULL)
    """
)
...
artist_table_create = (
    ...
    name varchar NOT NULL, location varchar, latitude numeric(11,8), 
